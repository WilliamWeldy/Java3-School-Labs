...
public class AccountLookupServlet extends HttpServlet {
    ...
    public void selectDB() { String sql = "SELECT Cid FROM Accounts WHERE AcctNo = " + htmlacct;
        try {
            ...
            Connection c1 = DriverManager.getConnection("jdbc:ucanaccess://C:/Users/DefaultTheMighty/Documents/NetBeansProjects/Java3_Lab06/Java3_Lab06/src/main/ChattBankMDB.mdb"); //connecting driver to the DB
