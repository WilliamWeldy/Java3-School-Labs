...
public class Account {
    ...
    public Account(String account, String ID, String type, Double balance) {
        acctNo = account;
        custId = ID;
        this.type = type;
    ...
    } public void display(String acctNo) { //Used to populate values before displaying without having to call selectDB()
        selectDB(acctNo);
        display();
    }
    
    public void selectDB(String acctNo) { sql = "SELECT * FROM Accounts WHERE AcctNo = " + acctNo;
        try {
